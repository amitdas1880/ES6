...
{
 super()                                   // If we define constructor in child class, and after inherit
    console.log ("constructor") ;            // the properties of parant class then it is necessary to define 
}                                            // supper () key under constructor.
getfruit ()
{
return "apple"; 
}
